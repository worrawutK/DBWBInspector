...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Dim ModeNoLinkCbitem() As String = {"DB1", "DB2", "DB3", "DB11", "DB12", "DB13", "DB14", "DB22", "DB22", "DB22", "DB22", "DB22", "DB22", "DB22", "DB22", "DB22", "DB22", "DB22", "DB22", "DB22", "DB22",
            "WB1", "WB2", "WB27", "WB27", "WB3", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "WB27", "DB22", "DWB", "WB27", "WB27"}
        Dim ItemList() As String = {"Chip Kake (Chipping)", "Chip Crack", "Aluminium Scratch", "Preform Over Flow", "Preform Thickness", "Preform Spread", "Preform Zure", "DIE TWIST", "DIE MISALIGNMENT", "SCRATCH", "PREFROM/SOLDER ON CHIP", "PREFROM/SOLDER ON LEAD", "IBUTSU ON CHIP", "IBUTSU ON LEAD", "FRAME BENT", "INNER LEAD BENT", "ZINK BENT", "ISLAND FLOAT", "BAD MAKE", "PAD HAGARE", "DIE DROP OFF",
            ...
            "AU-CUT [WB NG]", "B-HAZURE [WB NG]", "2ND OPEN ALARM [WB NG]", "WB NASHI [WB NG]", "1ST OPEN ALARM [WB NG]", "V-TSUKI ALARM [WB NG]", "OP SHORI [WB NG]", "ISLAND FLOAT [WB NG]", "ISLAND FLOAT [WB NG]", "LEAD COLOUR CHANGE [WB NG]", "INNER LEAD BENT [WB NG]", "PAD COLOUR CHANGE [WB NG]", "KAKE [WB NG]", "CRACK [WB NG]", "DIE TWIS [WB NG]T", "DIE MISALIGNMENT [WB NG]", "PREFROM OVER [WB NG]", "P/F ON LEAD [WB NG]", "PASTE BRIDGE [WB NG]", "CHIP OFF [WB NG]", "P/F ON CHIP [WB NG]", "DIE DROP OFF [WB NG]", "BAD MARK [WB NG]", "DOUBLE CHIP [WB NG]", "CHIP OUT [WB NG]", "IBUTSU ON CHIP/LEAD [WB NG]", "HOLIZONTAL CRACK [WB NG]", "DB NG", "CHIP MISORIENTATION [WB NG]", "MISSING DIE [WB NG]"}
