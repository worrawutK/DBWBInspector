...
Public Class TcpIpClient
    ...
    Private Sub ConnectEnd(ByVal pIAsyncResult As IAsyncResult)
        Try
            'Dim client As Socket = CType(pIAsyncResult.AsyncState, Socket)
            ...
            Else
                RaiseEvent TcpStatusConnect("Disconect")
                myConnect.Close()
            End If
    ...
    Private Function HexToByte(ByVal msg As String) As Byte()
        ...
        If msg.Length Mod 2 = 0 Then
            ...
            For i As Integer = 0 To _msg.Length - 1 Step 2
                comBuffer(i / 2) = CByte(System.Convert.ToByte(_msg.Substring(i, 2), 16))
            Next
