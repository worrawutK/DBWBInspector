...
Module Module1
    Public SelfConData As MCControl
    Friend ReadOnly _ipServer = "172.16.0.100"                      'ZION Server
    Friend ReadOnly _ipDbxUser = "172.16.0.102"                     'DBX,APCS  Server
    Friend TempPath As String = Application.StartupPath & "\LOG\Temp\"
    Friend TempDataBasePath As String = Application.StartupPath & "\LOG\TempDataBase\"
    Friend SelPath As String = Application.StartupPath & "\"
    ...
    Friend dt1 As Date = dt.AddMonths(-1)                           ' 1 mount
