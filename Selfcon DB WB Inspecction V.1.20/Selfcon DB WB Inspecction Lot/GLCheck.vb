Public Class GLCheck
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click, Button8.Click, Button7.Click, Button6.Click, Button5.Click, Button4.Click _
    , Button3.Click, Button9.Click
        'Form1.Hide()
        p = Process.GetProcessesByName("vncviewer")
        If p.Count > 0 Then
            For Each prog As Process In Process.GetProcesses
